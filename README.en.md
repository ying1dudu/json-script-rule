...
#### 前言
软件这一行业我做了有十多年了，从毕业时那会儿流行的jsp一直到现在的前后端分离，这期间经历了太多的技术更新迭代，而每一款技术的出现都极大的简化了我们的开发，让我们能够从容的应对日新月异的需求变化，简化我们开发者对于技术层面的思考，使得我们能够拥有更多的精力去面向业务层面的需求。
...
于是低代码这一名词慢慢的出现在了我们的视线里，作为一个技术人首先想到的就是用技术手段来解决这些繁琐平庸简单的问题，而刚巧在此时我换了一家公司，公司想要自研开发一款低代码平台，不过在我看来这种低代码平台市面上多得是，如果自己研究一款低代码平台除非你的设计比较新颖，否则意义并不大，走别人的老路如果做的又没别人好，那简直就是毁灭性的。然而遗憾的是公司最终还是决定开发低代码平台，对此我不做评判，每个人的想法都值得被尊重，只能说世间千里马常有而伯乐难为。好在我的方向是开源框架，因此完全可以做一个拓展接口来变向的支撑低代码平台，于是我坚持自己的想法，最终经过数个月的时间，终于打造一款开源的低代码框架，json script rule。
