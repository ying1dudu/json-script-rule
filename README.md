#### 前言
软件这一行业我做了有十多年了，从毕业时那会儿流行的jsp一直到现在的前后端分离，这期间经历了太多的技术更新迭代，而每一款技术的出现都极大的简化了我们的开发，让我们能够从容的应对日新月异的需求变化，简化我们开发者对于技术层面的思考，使得我们能够拥有更多的精力去面向业务层面的需求，进而达到用户满意的结果。
然而工作久了慢慢的对于平常的开发工作越来越厌倦了，厌倦按照别人设计的开发模式去走，厌倦了一个简单的列表功能我还要去建po、vo、do、dto，实在是太繁琐了，所有的人都按部就班的去工作，几乎没有人想过这些东西到底有没有用，只是照着去做，从早到晚做着重复且毫无价值可言的工作，于是久而久之我渐渐也有了自己的想法，为什么不做一款简单实用的框架出来呢？而刚巧我在此时换了一家公司，他们想要开发一款低代码平台，不过对此其实我是不太感兴趣的，我所感兴趣的是做一款开源的低码框架，能够应用于所有开发者而不仅仅只是公司的底码平台，目标做一个第三方jar包，如mybatis，于是想到这里说干就干。
首先一款新技术的出现一定是能够解决开发者的一些痛点的，那么这就绕不开传统框架里都有哪些痛点的这个话题，以下简单罗列出几个常见的痛点：
...
2.封装好后的插件事实上就是一个java的class类，将这个类上传到公网便可以开源，将这个class类下载后放入本公司内部的action库即可使用，非常方便。
